import{s as d}from"./store-BAgcX4VC.js";function m(r,e=null,t="INQUIRY"){const i=r.replace(/[^0-9]/g,"");let a="";e?(t==="BUY"||t==="INQUIRY")&&(a=`Hello! I am interested in getting the *${e.name}* (${e.ram} / ${e.storage}).
