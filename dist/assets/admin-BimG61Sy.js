import{A as O,s as r,d as C,i as k,u as P,g as T,a as $}from"./store-Da1MZaWI.js";document.addEventListener("DOMContentLoaded",()=>{_()});function _(){const n=document.getElementById("adminLoginOverlay"),t=document.getElementById("adminContent"),l=document.getElementById("loginForm"),s=document.getElementById("loginError"),o=document.getElementById("loginPassword"),a=document.getElementById("togglePwdVisibility");if(sessionStorage.getItem("adminAuth")==="granted"){E(n,t);return}n&&(n.style.display="flex"),t&&(t.style.display="none"),a&&o&&a.addEventListener("click",()=>{const i=o.type==="text";o.type=i?"password":"text",a.textContent=i?"👁️":"🙈"}),l&&l.addEventListener("submit",i=>{i.preventDefault(),o.value===O?(sessionStorage.setItem("adminAuth","granted"),s&&(s.style.display="none"),E(n,t)):(s&&(s.style.display="block"),o.value="",o.focus(),l.style.animation="shake 0.35s ease",setTimeout(()=>{l.style.animation=""},400))})}function E(n,t){n&&(n.style.display="none"),t&&(t.style.display="block"),A(),F(),K(),N()}function A(){const n=document.querySelector(".admin-header-bar > div:last-child");if(!n||document.getElementById("logoutBtn"))return;const t=document.createElement("button");t.id="logoutBtn",t.className="btn btn-call btn-sm",t.innerHTML="🚪 Logout",t.addEventListener("click",()=>{sessionStorage.removeItem("adminAuth"),location.reload()}),n.appendChild(t)}const w=document.createElement("style");w.textContent=`@keyframes shake {
